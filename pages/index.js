            ...
            <div className="grid">
              ...
              <div className="message">
                ...
                <p>
                  ...
                  eligendi illo quam temporibus deserunt asperiores iste, minus
                  molestiae quo. Aliquid maiores inventore animi quaerat fugiat.
                </p>
              </div>
              <div className="message">
                <div className="message-heading">
                ...
                <p>
                  ...
                  molestiae minus velit ea consectetur! Nesciunt dolore porro ad
                  deleniti, error magnam harum quisquam distinctio officia eius
                  id magni, pariatur dolorum!
                </p>
              </div>
              <div className="message">
                <div className="message-heading">
                ...
                <p>
                  ...
                  eligendi ab delectus numquam, nulla animi sit ex. Aperiam amet
                  sequi accusamus, architecto quos veniam animi, labore magnam
                  eaque eos voluptatum!
                </p>
              </div>
            </div>
          </div>
